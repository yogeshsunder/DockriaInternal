...
namespace WebApp.Areas.Identity.Pages.Account.Manage
{
    public class IndexModel : PageModel
    {
        ...
        {
            // Use the id parameter as needed in your OnGetAsync action
            ViewData["RandomString"] = id;

            // If id is not provided or is empty, generate a new random code
            if (string.IsNullOrEmpty(id))
            {
                string randomCode = GenerateRandomCode();
                ViewData["RandomString"] = randomCode;
                return RedirectToPage(new { id = randomCode });
            }
