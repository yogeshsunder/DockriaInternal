...
function deleteDocumentType(url) {
    ...
    // Get the document name before showing the confirmation dialog
    var documentName = dataTable.row($(this).parents('tr')).data().docTypeName;

    // Show a confirmation dialog using SweetAlert
    swal({
        title: `Do you want to delete the document "${documentName}"?`, // Display the document name
        icon: 'warning',
        buttons: {
            delete: {
                text: 'Delete',
